...
\begin{example}
	...
	$m\in\{1,\dots,n\}$. Since the $\chi_1,\dots,\chi_n$ are all differnt and $G$ admits $n$ irreducible representations,
...
Let \[
	...
	\]
     With the trivial representation, the sign and these two characters we found, we are almost done. Only one irreducible character is still missing. Let us call this
     character $\chi_5$. This character can be computed 
