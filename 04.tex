...
\subsection{Frobenius' divisibility theorem}
\label{degree}

\begin{theorem}[Frobenius]
\index{Frobenius!divisibility theorem}
...
\subsection{Schur's divisibility theorem}

\begin{theorem}[Schur]
\index{Schur!divisibility theorem}
...
The following conjecture was proposed in 2018:

\begin{conjecture}[Harada]
\index{Harada's conjecture}
    Let $G$ be a finite
    group and let $K_1,\dots,K_r$ be its conjugacy classes. 
    Then $\prod_{\chi\in\Irr(G)}\chi(1)$ divides
    $\prod_{i=1}^r|K_i|$. 
\end{conjecture}
...
\begin{example}
\index{Character table!of $C_2\times C_2$}
...
Let \[
    ...
    \index{Character table!of $\Sym_4$}
...
\begin{exercise}
\label{xca:order5}
\index{Character table!of $\D_4$}
\index{Character table!of $Q_8$}
