...
\begin{proof}
    ...
    \]
    If $|C_i|>m^2$ for all $i\in\{2,\dots,k\}$, then, since 
    \[
...
\begin{proof}
  ...
  First, $\Ind_H^G\alpha(1)=\alpha(1)=0$. If $h\in H\setminus\{1\}$, then, by Corollary~\ref{cor:induccion}, 
  \[
  ...
  that is 
  $\Ind_H^G\alpha=\pm\eta$ for some $\eta\in\Irr(G)$. Since 
  \[
