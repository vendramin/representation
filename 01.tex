...
The ideas behind the theorem are somewhat connected to Sylow's  theory. The key is to consider explicit version of Sylow's theorem for the group $\GL_n(p)$ of invertible matrices 
